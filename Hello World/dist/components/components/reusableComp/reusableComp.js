System.register(['@angular/core', './imageComp'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        setters:[
            ...
            function (imageComp_1_1) {
                imageComp_1 = imageComp_1_1;
            }],
        execute: function() {
            ReusableComponent = (function () {
                function ReusableComponent() {
                }
                ReusableComponent.prototype.pressed = function (event) {
                    alert("Image has been clicked");
                };
                ReusableComponent = __decorate([
                    core_1.Component({
                        selector: 'reusableComp',
                        directives: [imageComp_1.ImageComponent],
