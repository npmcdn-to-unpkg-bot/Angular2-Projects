System.register(['@angular/core', './childOne'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            parentCompo = (function () {
                function parentCompo() {
                    var _this = this;
                    this.count = 10;
                    setInterval(function () { return _this.count++; }, 1000);
                }
                parentCompo = __decorate([
                    core_1.Component({
                        selector: 'parent',
                        templateUrl: 'components/childInput/parentComp.html',
                        directives: [childOne_1.childOneComponent]
                    }), 
                    __metadata('design:paramtypes', [])
                ], parentCompo);
                return parentCompo;
            }());
            exports_1("parentCompo", parentCompo);
        }
    }
});
